...
func (i integrationTest) AuthenticateUser(username, password string) (*User, error) {
...
func (i integrationTest) LookupClient(id string) (*Client, error) {
...
func (i integrationTest) Authorize(c *Client, u *User, scope string) (*Authorization, error) {
